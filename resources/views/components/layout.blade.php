   	...
   	<body class="min-h-screen flex flex-col bg-base-200 font-sans">
		<nav class="navbar bg-base-100">
			...
			<div class="navbar-end gap-2">
                @auth
                    ...
                    <a href="{{ route('chirps.liked') }}" class="btn btn-ghost btn-sm">
                        ♥ Liked
                    </a>
                    <a href="{{ route('profile.edit') }}" class="text-sm">{{ auth()->user()->name }}</a>
        ...
        <footer class="footer sm:footer-horizontal bg-neutral text-neutral-content items-center p-4">
            <aside class="grid-flow-col items-center justify-center">
                ...
                <p>Copyright &copy; {{ now()->year }} - All right reserved</p>
            </aside>
